...
class QA extends React.Component {
    render() {
      return (
        <div className='Guide'>
          <h3>Step-by-Step Guide:<h4>How to Choose a Diamond</h4></h3><br/>
  <p>
...
<br/>
<ul>
  <li>First, lower the Clarity. See clarity buying tips (below) for more guidance. Go as low as VS2 before making concessions in other areas.
</li>
  <li>Next, lower the Color. See color buying tips (below) for more guidance. Go as low as H before making concessions in other areas.
</li>
  <li>Finally, lower the Cut. See cut buying tips (below) for more guidance. Go as low as Very Good in round diamonds, and Good in fancy shapes before making concessions in other areas.
</li>
<li>If the diamonds that match your revised criteria are close to your budget, consider shaving off some carat weight in order to close the gap. A carat weight difference of 10% or less will be very difficult to detect visually.
</li>
</ul>
